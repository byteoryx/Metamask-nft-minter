...
HEYELSA_URL = 'https://app.heyelsa.ai/'
...
DEFAULT_TWITTERS = BASE_PATH + 'twitters.txt'
DEFAULT_DISCORDS = BASE_PATH + 'discords.txt'
DEFAULT_REF_CODES = BASE_PATH + 'ref_codes.txt'
DEFAULT_PROGRESS_FILE = BASE_PATH + 'progress.json'
DEFAULT_LOGS_FILE = BASE_PATH + 'logs.txt'
LOGS_SIZE = '10 MB'
...
PROJECT = r"""
 _     _ __   __  _____  _______  ______ _______ _    _ _______
